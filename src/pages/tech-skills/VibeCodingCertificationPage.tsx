  ...
  const generateCertificate = useCallback(async () => {
    ...
    try {
      await generateCertificatePdf({
        ...
        description: [
          'For successfully completing the Vibe Coding Certification,',
          'demonstrating the ability to communicate intent clearly to AI, critique and refine prompts,',
          'generate working code, and iterate based on execution results.',
        ],
        scoreSuffix: `· Language: ${certLanguage.toUpperCase()}`,
        assessmentScores,
        branding,
        theme: 'pink',
        idPrefix: 'VIBE',
        filenameSuffix: 'VibeCoding',
      });
